              ...
              <tr key={log.id} className="hover:bg-muted/20 transition-colors group">
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-[10px] uppercase tracking-tight text-foreground">{log.school_name || 'Umum'}</span>
                  </div>
                </td>
                <td className="px-6 py-4">
                   <div className="flex items-center gap-2">
                     <User className="w-3.5 h-3.5 text-muted-foreground" />
                     <span className="font-bold text-foreground">{log.student_name}</span>
                   </div>
                </td>
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 bg-muted text-muted-foreground rounded-lg text-[10px] font-black border border-border">
                    {log.class_name}
                  </span>
                </td>
                <td className="px-6 py-4">
